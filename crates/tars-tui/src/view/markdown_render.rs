use crate::view::line_utils::line_to_static;
use crate::view::wrapping::RtOptions;
use crate::view::wrapping::word_wrap_line;
...
// (Codex's external insta-snapshot module `markdown_render_tests.rs` is not
// vendored — M0a keeps the inline `pretty_assertions` unit tests below.)
