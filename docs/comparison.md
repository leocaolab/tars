...
- You're building **agent-quality evaluation pipelines** (NVIDIA's Agentic Apps team's "ways to stand out" — see [Doc 16](./architecture/zh/16-evaluation-framework.md)) and need a runtime that emits typed events you can replay against.
