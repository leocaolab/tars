...
| M8 Python bindings (`tars-py`) | 🟢 in progress      | Stages 1-4 + B-31 + B-20 W1+W2+W4 + v3 + v2 (typed Reject reasons) shipped. Remaining: Pipeline.builder Python surface (B-6c). |
